...
= 2.1.5 =
* Fixed: Grid gap issue 

= 2.1.4 =
* Added: Logo Grid Layout
* Added: Multiple rows pro feature is introduced
* Fixed: Logo sizing issue 

= 2.1.3 =
* Fixed: Dynamic Style issue

= 2.1.2 =
* Fixed: Logo background issue

= 2.1.1 = 
* Added: Navigation style options 
* Added: Pagination style options
* Fixed: Initial carousel loading issue 
* Fixed: depreciated warning issue 
* Improved: SCSS codes

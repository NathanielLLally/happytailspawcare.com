...
//        }
    ...
    public static function custom_admin_pointers()
    {
        ...
        $new_pointer_content .= 'This version fixes a referrer policy issue for some users in certain browsers for both free and <a target=_blank href="' . self::$epbase . '/dashboard/pro-easy-video-analytics.aspx?ref=frompointer">pro</a> users.';

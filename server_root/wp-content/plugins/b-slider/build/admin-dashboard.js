...
/* harmony import */ var _bpl_tools_Admin_Pricing_Pricing__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../bpl-tools/Admin/Pricing/Pricing */ "../bpl-tools/Admin/Pricing/Pricing.js");
/* harmony import */ var _bpl_tools_Admin_FeatureCompare_FeatureCompare__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../bpl-tools/Admin/FeatureCompare/FeatureCompare */ "../bpl-tools/Admin/FeatureCompare/FeatureCompare.js");
...
const App = props => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_1__.HashRouter, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_1__.Routes, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_1__.Route, {
    ...
    path: "pricing",
    element: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_bpl_tools_Admin_Pricing_Pricing__WEBPACK_IMPORTED_MODULE_4__["default"], {
    ...
    element: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_bpl_tools_Admin_FeatureCompare_FeatureCompare__WEBPACK_IMPORTED_MODULE_5__["default"], {
      featureCompareInfo: _utils_data__WEBPACK_IMPORTED_MODULE_7__.featureCompareInfo,
      ...props
    })
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_1__.Route, {
    path: "*",
...
const dashboardInfo = info => {
  ...
  return {
    name: `bSlider ${proSuffix}`,
    displayName: `bSlider ${proSuffix}  – Responsive Image Slider`,
    description: 'bSlider is Gutenberg Block an image and text slider. Using this slider you can create your slider very easily and in a short time. bSlider is the best match for you and your customers. You can use any theme.',
    slug,
    logo: `https://ps.w.org/${slug}/assets/icon-128x128.png`,
    // banner: `https://b-slider.bplugins.com/wp-content/uploads/2025/09/welcome-2.png`,
    video: 'https://www.youtube.com/watch?v=qgSBHjGdegg',
    isYoutube: true,
    version,
    isPremium,
    hasPro,
...
const changelogs = [{
  ...
  version: '1.1.29 – 23 July, 2025',
  list: ['Resolved dashboard target element issue;']
}, {
  version: '1.1.28 – 8 July, 2025',
  list: ['Added four source types: Image, Posts, WooCommerce, and Video.', 'Added four layout types: Slider, Carousel, Grid, and Thumbnails']
}];
const demoInfo = {
  title: 'Live Overview',
  ...
  demos: [{
    icon: '',
    title: 'Posts Default Layout Fade Effect',
    description: '',
    category: '',
    type: 'iframe',
    ...
    icon: '',
    title: 'Posts Carousel Grid Style',
    description: '',
    category: '',
    type: 'iframe',
    ...
    icon: '',
    title: 'Posts Carousel Ticker Style',
    description: '',
    category: '',
    type: 'iframe',
    ...
    icon: '',
    title: 'Posts Carousel Center Style',
    description: '',
    category: '',
    type: 'iframe',
    ...
    icon: '',
    title: 'Video Carousel Ticker Style',
    description: '',
    category: '',
    type: 'iframe',
    ...
    icon: '',
    title: 'Video Carousel Center Style',
    description: '',
    category: '',
    type: 'iframe',
    ...
    icon: '',
    title: 'Woo Carousel Ticker Style',
    description: '',
    category: '',
    type: 'iframe',
    ...
    icon: '',
    title: 'Woo Carousel Center Style',
    description: '',
    category: '',
    type: 'iframe',
    ...
    icon: '',
    title: 'Video Default Layout Fade Effect',
    description: '',
    category: '',
    type: 'iframe',
    ...
    icon: '',
    title: 'Video Default Layout Image Indicators',
    description: '',
    category: '',
    type: 'iframe',
    ...
    icon: '',
    title: 'Woo Default Layout Fade Effect',
    description: '',
    category: '',
    type: 'iframe',
    ...
    icon: '',
    title: 'Woo Default Layout Image Indicators',
    description: '',
    category: '',
    type: 'iframe',
    ...
    icon: '',
    title: 'Vertically Image Indicators Left',
    description: '',
    category: '',
    type: 'iframe',
    ...
    icon: '',
    title: 'Vertically Image Indicators Right',
    description: '',
    category: '',
    type: 'iframe',
...
const featureCompareInfo = {
  ...
  plans: [{
    ...
    id: 'lhmjqhkeyi',
    name: `<span style='color: #485781;'>Pro Start from </span><span style='font-size: 1.3em;'>$29 Only</span>`,
    color: '#146EF5'
  }],
  features: [{
    label: 'Unlimited Slides: Create as many slides as you need for products, portfolios, or content highlights.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Easy Slide Management: Quickly duplicate or remove slides for faster editing and organization.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Customizable Content Styles: Style titles and descriptions with flexible typography and design controls.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Navigation Buttons: Add left and right arrows with customizable size, color, and border radius.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Slide Indicators: Choose from different styles and positions to help users navigate easily.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Autoplay Controls: Turn autoplay on or off, set custom duration, and adjust timing per slide.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Hover Pause: Pause the slider when users hover, improving interactivity and focus.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Overlay Colors: Add color overlays on slides for better contrast and text visibility.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Slide Animations: Apply smooth transitions like fade, slide, or flip to catch attention.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Content Positioning: Align text and elements at the default or middle area of the slide.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Arrow Styling: Customize arrow size, height, width, border, and color to match your theme.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Carousel Layout: Create looping, autoplay carousels with horizontal or vertical direction.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Grid Layout: Display sliders in responsive grids with adjustable column and row gaps.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Thumbnails Layout: Add thumbnail navigation with overlay, autoplay, and border options.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Post Slider Options: Query posts by category or tag, show excerpts, and limit content length.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'WooCommerce Slider: Highlight products with content length and excerpt display controls.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Video Slider Options: Enable popup playback with repeat, mute, autoplay, reset, or hide controls.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Basic Video Controls: Show a large play button and restart option for easier interaction.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Gutenberg Block: Add sliders directly in the block editor with full customization.',
    plans: ['ztbk4ex2fyi', 'lhmjqhkeyi']
  }, {
    label: 'Shortcode Support: Place sliders anywhere on your site using shortcodes.',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Advanced Carousel Styles: Create unique carousels with ticker, grid, and 3D effects.',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Creative Effects: Use coverflow and card-style transitions for modern visual appeal.',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Buttons in Content: Add clickable buttons inside slides for CTAs and product links.',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Advanced Animations: Control timing, delay, and duration for text and button animations.',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Custom Image Indicators: Replace default indicators with images for a more branded look.',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Multiple Arrow Icons: Select from different arrow styles to fit your design.',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Flexible Content Positioning: Place content anywhere within each slide for more control.',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Drag-and-Drop Reordering: Organize slides easily by dragging and dropping items.',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Mouse Controls: Navigate with the mouse wheel, dragging, or grab the cursor for better usability.',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Arrow Follow Mouse: Enable arrows that follow mouse movement for dynamic navigation.',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Responsive Slider Height: Adjust slider height per device for better responsiveness.',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Advanced Post Controls: Set posts per page, change order, exclude/include posts, or skip current post.',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'WooCommerce Advanced Options: Apply the same filters and display controls to products.',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Full Video Controls: Unlock rewind, fast forward, progress bar, time display, mute, volume, PIP, AirPlay, download, and full screen.',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Grid Pagination: Add pagination with options for load more or numbered pages, aligned left, right, or center.',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Pagination Styling: Customize buttons with typography, colors, padding, and borders.',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Enhanced Thumbnails: Control navigation arrows, overlays, cursor options, and direction for thumbnails.',
    plans: ['lhmjqhkeyi']
  }, {
    label: 'Multiple Layouts: Switch between slider, carousel, grid, or thumbnails for flexible presentations.',
    plans: ['lhmjqhkeyi']
  }]
};

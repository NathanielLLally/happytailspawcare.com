...
class UELM_UniteCreatorAPIIntegrations{
	...
	public function addServiceSettingsFields($settingsManager, $type, $name, $condition = null){
		...
		// add the fields
		UELM_HelperProviderUC::addSettingsFields($settingsManager, $fields, $name, $condition);
	}
	...
	private function getGoogleReviewsSettingsFields(){
		...
		$fields = array_merge($fields, array(
			...
			array(
				...
				"desc" => sprintf(__("Optional. Specify a language code. Example: de and google will translate the review.", "unlimited-elements"), self::GOOGLE_REVIEWS_DEFAULT_CACHE_TIME),
				"default" => "",
			)
		));
